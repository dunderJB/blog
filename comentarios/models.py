...
class Comentario(models.Model):
    ...
    data_comentario = models.DateTimeField(default=timezone.now, verbose_name='Data do comentário')
    publicado_cometario = models.BooleanField(default=False, verbose_name='Publicado?')
